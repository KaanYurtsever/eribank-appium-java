...
public class PaymentForCountries implements Task {
    ...
    public static PaymentForCountries info(Integer country) {
        return instrumented(PaymentForCountries.class,country);
    }
}
